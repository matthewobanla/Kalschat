...
export const Route = createFileRoute("/acceptable-use")({
  head: () => ({ meta: [{ title: "Acceptable Use Policy — Kalschat" }] }),
...
function AcceptableUse() {
  return (
    <LegalPage
      ...
      description="Use Kalschat to bring people together without putting people, communities, or the service at risk."
    >
      <section>
        <h2>1. Safety and illegal activity</h2>
        <p>You may not use Kalschat to:</p>
        <ul>
          ...
          <li>Share another person’s highly sensitive information without authorization or use Kalschat for stalking.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Do not probe, scan, or exploit Kalschat or another user’s systems without clear authorization.</li>
        ...
        <p>
          ...
          Report findings privately to hello@kalschat.app.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          and supporting context to hello@kalschat.app. Do not place illegal or highly
